...
class Test_cc < Minitest::Test
	...
	def test_35
		assert_equal({quarter: 1, dime: 1, nickel: 0, penny: 0}, cc(35))
	end

	def test_57
		assert_equal({quarter: 2, dime: 0, nickel: 1, penny: 2}, cc(57))
	end

	def test_88
		assert_equal({quarter: 3, dime: 1,  nickel: 0, penny: 3}, cc(88))
	end
